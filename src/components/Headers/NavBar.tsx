...
const NavBar = () => {
    ...
    useEffect(() => {
        ...
        if (address) {
            dispatch(
                getAccountAssets({ chain: selectedChain, address, gateway })
            );
            dispatch(
                getInfluenceDepositTxns({
                    chain: selectedChain,
                    ...
                    <Toolbar disableGutters>
                        ...
                        >
                            ...
                            >
                                {pages.map((page) => (
                                    <Link
                                        id={NAV_BAR_MENU_APPBAR_ITEM_ID(
                                            page.title
                                        )}
                                        key={page.title}
                                        href={page.url}
                                ...
                                <>
                                    ...
                                    >
                                        ...
                                        {settings.map((setting) => (
                                            <MenuItem
                                                id={NAV_BAR_SETTINGS_MENU_ITEM_ID(
                                                    setting.label
                                                )}
                                                sx={{
