...
const pages = [
  ...
  { title: `Rebelion`, url: `/rebelion` },
  { title: `CLI`, url: `/cli` },
] as PageConfiguration[];

const settings = [`AlgoExplorer`, `My NFTs`, `Logout`];
const BUG_REPORT_URL = `https://github.com/algorealm/algorealm-ui/issues/new`;
                  ...
                  >
                    ...
                    <ValueSelect
                      ...
                      onSelect={(value: string) => {
                        dispatch(setChain(value as ChainType));
                      }}
                    />
                    <Divider />
                    <ValueSelect
