            ...
            <DialogContent>
                ...
                {pack && pack.creator === address && (
                    <Typography variant="h6" color={`warning.main`}>
                        You can not perform the purchase since you are the
                        creator...
                    </Typography>
                )}
                {swapIsActiveState.loading && (
                ...
                {(hasZeroBalanceAssets ||
                    ...
                    <Typography variant="h6" color={`warning.main`}>
                        Sorry this pack was recently purchased. The pack will be
                        moved to purchased tab within next 60 minutes.
                    </Typography>
                )}
